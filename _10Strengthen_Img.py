...
def get_random_data(imgs_path, expect_num, output_path, All=False):
    """
    :param imgs_path: 原始图像的路径
    :param expect_num: 需要的图片的数量
    :param output_path: 输出的保存的图片的路径
    :param All: 是否要保存所有的图片
    :return:
    """
...
class Dataset_Strengthen(object):
    ...
    def Read_Transform(self):
        ...
        for Img in Imgs:
            ...
            # 最大池化
            Transformed_Img = pooling(Transformed_Img, G=2, mode="Mean")
